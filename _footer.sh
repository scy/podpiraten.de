...
<div id="foot">
<a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/de/"><img alt="Creative Commons License" style="border-width:0" src="cc-by-sa.png" width="88" heigth="31" /></a><br />
...
© 2009 Podpiraten&nbsp;— <span class="epost">post klammeraffe podpiraten pünktele de</span>&nbsp;— <a href="http://scytale.name/contact/">vorläufiges Impressum</a>
</div>
</div></body>
</html>
EOF
